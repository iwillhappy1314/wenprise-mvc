...
class Asset implements IAsset {
	...
	/**
	 * @var \Wenprise\Hook\ActionBuilder
	 */
	protected $action;

	/**
	 * @var \Wenprise\Html\HtmlBuilder
	 */
	protected $html;

	/**
	 * @var \Wenprise\Hook\FilterBuilder
	 */
	protected $filter;
	 ...
	 * @param string                     $type
	 * @param array                      $args
	 * @param \Wenprise\Hook\IHook       $action
	 * @param \Wenprise\Html\HtmlBuilder $html
	 * @param \Wenprise\Hook\IHook       $filter
	 */
